...
#ifndef MAIN_CPP_ARROWRIGHT_H
#define MAIN_CPP_ARROWRIGHT_H

#include "../comp/rectangle.h"

namespace LewzenServer {
    class ArrowRight : virtual public Rectangle {
    protected:
        // 实际SVGI
        std::shared_ptr<Lewzen::SVGIPath> SVGIPath;
        // 额外的关键点
        std::shared_ptr<CorePoint> ControlLeft;
        std::shared_ptr<CorePoint> ControlRight;
        double padding = 5;
